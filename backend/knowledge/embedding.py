...
from backend.config.runtime_data import PROJECT_ROOT, TMP_ROOT, configure_caches, migrate_file

configure_caches()
_DEFAULT_STATE_PATH = migrate_file(PROJECT_ROOT / "data" / "bm25_state.json", TMP_ROOT / "knowledge" / "bm25_state.json")
