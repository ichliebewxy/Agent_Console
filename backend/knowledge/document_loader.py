...
class DocumentLoader:
    ...
    def __init__(self, chunk_size: int = 500, chunk_overlap: int = 50, image_output_dir: str | None = None):
        # 1. 初始化三层滑动窗口分块器
        ...
        # 2. 初始化图片临时存储目录和视觉大模型
        self.image_output_dir = str(image_output_dir or TMP_ROOT / "knowledge" / "extracted_images")
